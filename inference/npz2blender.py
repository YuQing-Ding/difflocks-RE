...
def export_alembic(out_alembic_path, resolution):
    ...
    export_kwargs = {
        ...
        # Present in older Blender versions, removed in Blender 5.1.
        "visible_objects_only": True,
    }
    supported_props = set(bpy.ops.wm.alembic_export.get_rna_type().properties.keys())
    export_kwargs = {k: v for k, v in export_kwargs.items() if k in supported_props}
    bpy.ops.wm.alembic_export(**export_kwargs)
